...
export class ResumeComponent {
  ...
  // Profile Summary
  profile = [
    'Software Engineer with over 7 years of experience in developing scalable, observable, robust web applications, and staying up to date with .Net ecosystem best practices, trends, developments, and innovations.',
